...
export default function Header() {
    ...
    return (
        ...
        <header className="sticky top-0 w-full z-50 bg-surface/80 backdrop-blur-xl h-20 border-b border-outline-variant/20 shadow-md ">
            ...
            <li><a onClick={toggleMenu} className={`font-headline-lg text-headline-lg tracking-widest uppercase transition-colors ${activeSection === 'home' ? 'text-secondary dark:text-secondary-fixed border-b-2 border-secondary pb-1' : 'text-on-surface-variant dark:text-on-surface-variant hover:text-secondary'}`} href="#home">Home</a></li>
            <li><a onClick={toggleMenu} className={`font-headline-lg text-headline-lg tracking-widest uppercase transition-colors ${activeSection === 'projects' ? 'text-secondary dark:text-secondary-fixed border-b-2 border-secondary pb-1' : 'text-on-surface-variant dark:text-on-surface-variant hover:text-secondary'}`} href="#projects">Projects</a></li>
            <li><a onClick={toggleMenu} className={`font-headline-lg text-headline-lg tracking-widest uppercase transition-colors ${activeSection === 'products' ? 'text-secondary dark:text-secondary-fixed border-b-2 border-secondary pb-1' : 'text-on-surface-variant dark:text-on-surface-variant hover:text-secondary'}`} href="#products">Products</a></li>
            <li><a onClick={toggleMenu} className={`font-headline-lg text-headline-lg tracking-widest uppercase transition-colors ${activeSection === 'contact' ? 'text-secondary dark:text-secondary-fixed border-b-2 border-secondary pb-1' : 'text-on-surface-variant dark:text-on-surface-variant hover:text-secondary'}`} href="#contact">Contact</a></li>
            </ul>
            </div>
        </>
    )
