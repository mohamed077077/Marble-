    ...
    return (
        ...
        <header className="sticky top-0 w-full z-50 bg-surface/80 backdrop-blur-xl h-20 border-b border-outline-variant/20 shadow-md ">
            ...
            <ul className="flex flex-col items-center space-y-8 text-center">
                <li><a onClick={toggleMenu} className={`font-headline-lg text-headline-lg uppercase tracking-widest inline-block transition-all duration-300 ${activeSection === 'home' ? 'text-secondary dark:text-secondary-fixed border-b-2 border-secondary pb-1 scale-95 active:scale-90' : 'text-on-surface-variant dark:text-on-surface-variant hover:text-secondary'}`} href="#home">Home</a></li>
                <li><a onClick={toggleMenu} className={`font-headline-lg text-headline-lg uppercase tracking-widest inline-block transition-all duration-300 ${activeSection === 'projects' ? 'text-secondary dark:text-secondary-fixed border-b-2 border-secondary pb-1 scale-95 active:scale-90' : 'text-on-surface-variant dark:text-on-surface-variant hover:text-secondary'}`} href="#projects">Projects</a></li>
                <li><a onClick={toggleMenu} className={`font-headline-lg text-headline-lg uppercase tracking-widest inline-block transition-all duration-300 ${activeSection === 'products' ? 'text-secondary dark:text-secondary-fixed border-b-2 border-secondary pb-1 scale-95 active:scale-90' : 'text-on-surface-variant dark:text-on-surface-variant hover:text-secondary'}`} href="#products">Products</a></li>
                <li><a onClick={toggleMenu} className={`font-headline-lg text-headline-lg uppercase tracking-widest inline-block transition-all duration-300 ${activeSection === 'contact' ? 'text-secondary dark:text-secondary-fixed border-b-2 border-secondary pb-1 scale-95 active:scale-90' : 'text-on-surface-variant dark:text-on-surface-variant hover:text-secondary'}`} href="#contact">Contact</a></li>
            </ul>
            </div>
        </>
    )
