...
export default function Card({ title, imageUrl, className = "block" }: CardProps) {
    return (
        <div className={`group relative overflow-hidden rounded-lg bg-surface-container-high/60 backdrop-blur-md border-t border-l border-outline-variant/30 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] ${className}`}>
