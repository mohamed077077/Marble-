...
export default function Product({ name, image, isFocused }: ProductProps) {
    return (
        <div className={`group relative overflow-hidden rounded-lg bg-surface-container-high border border-outline-variant/30 shadow-md aspect-square flex items-end transition-all duration-500 ease-in-out ${
